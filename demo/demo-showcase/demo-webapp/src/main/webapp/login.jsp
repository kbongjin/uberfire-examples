...
<head>
  ...
  <link rel="stylesheet" href="com.bong.DemoShowcase/patternfly/dist/css/patternfly.min.css">
</head>

<body>
<span id="badge">
  <img src="com.bong.DemoShowcase/images/uf_logo.png" alt="UberFire Logo" title="Powered By Uberfire"/>
</span>
<div class="container">
  <div class="row">
    <div class="col-md-12">
      <div id="brand">
        <img src="com.bong.DemoShowcase/images/uf.png" alt="Uberfire UI Framework">
      </div>
    </div>
